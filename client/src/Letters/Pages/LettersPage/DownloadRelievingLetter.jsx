...
const DownloadRelievingLetter = () => {
  ...
  useEffect(() => {
    const fetchAllFilterOptions = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/relieving-letters`, {
  ...
  const fetchLetters = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      let url = `${process.env.REACT_APP_API_URL}/api/relieving-letters?page=${currentPage}&limit=${limit}`;
