...
function UserHome() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(window.API_BASE + "/lead", { u_Id: user.u_Id, ...leadForm })
      .then((res) => {
  ...
  const handleUpdateLead = (e, lead) => {
    ...
    axios
      .post(window.API_BASE + "/updateLead", { ...leadForm })
      .then((res) => {
        console.log(res.data);
        return res.data;
      })
  ...
  const hanldefollowUp = (e) => {
    ...
    axios
      .put(window.API_BASE + "/updateMeeting", {
        u_Id: user.u_Id,
        userName: user.name,
        emails: user.email,
        ...leadForm,
  ...
  useEffect(() => {
    axios
      .get(`${window.API_BASE}/getlead/${user.u_Id}`)
      .then((responce) => {
