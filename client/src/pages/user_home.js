...
function UserHome() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:3000/lead", { u_Id: user.u_Id, ...leadForm })
      .then((res) => {
  ...
  const handleUpdateLead = (e, lead) => {
    ...
    axios
      .post("http://localhost:3000/updateLead", { ...leadForm })
      .then((res) => {
        console.log(res.data);
        return res.data;
      })
  ...
  const hanldefollowUp = (e) => {
    ...
    axios
      .put("http://localhost:3000/updateMeeting", {
        u_Id: user.u_Id,
        userName: user.name,
        emails: user.email,
        ...leadForm,
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3000/getlead/${user.u_Id}`)
      .then((responce) => {
