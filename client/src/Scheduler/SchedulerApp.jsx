...
function Navigation() {
  ...
  const isActive = (path) => {
    if (path === "/task/scheduler") {
      return (
        location.pathname === "/task/scheduler" ||
        location.pathname === "/task/scheduler/"
      );
    }
        ...
        >
          <Link
            ...
            style={{
              ...
              fontSize: "0.85rem",
              fontWeight: 600,
              background: isActive("/task/scheduler")
                ? "#ffffff"
                : "transparent",
              color: isActive("/task/scheduler")
                ? "var(--primary)"
                : "var(--text-secondary)",
              boxShadow: isActive("/task/scheduler")
                ? "0 2px 8px rgba(15, 23, 42, 0.05)"
                : "none",
              border: isActive("/task/scheduler")
          ...
          <Link
            ...
            style={{
              ...
              fontSize: "0.85rem",
              fontWeight: 600,
              background: isActive("/task/scheduler/history")
                ? "#ffffff"
                : "transparent",
              color: isActive("/task/scheduler/history")
                ? "var(--primary)"
                : "var(--text-secondary)",
              boxShadow: isActive("/task/scheduler/history")
                ? "0 2px 8px rgba(15, 23, 42, 0.05)"
                : "none",
              border: isActive("/task/scheduler/history")
                ? "1px solid var(--border-glass)"
                : "1px solid transparent",
              borderRadius: "8px",
              transition: "all var(--transition-fast)",
          ...
          <Link
            ...
            style={{
              ...
              fontSize: "0.85rem",
              fontWeight: 600,
              background: isActive("/task/scheduler/notifications")
                ? "#ffffff"
                : "transparent",
              color: isActive("/task/scheduler/notifications")
                ? "var(--primary)"
                : "var(--text-secondary)",
              boxShadow: isActive("/task/scheduler/notifications")
                ? "0 2px 8px rgba(15, 23, 42, 0.05)"
                : "none",
              border: isActive("/task/scheduler/notifications")
                ? "1px solid var(--border-glass)"
                : "1px solid transparent",
              borderRadius: "8px",
              position: "relative",
