...
const AddData = () => {
    ...
    const handleAddProject = async () => {
        ...
        try {
            await axios.post('https://sf.doaguru.com/api/projects', { name: projectName, department: projectDepartment.join(', ') });
    ...
    const handleAddCategory = async () => {
        ...
        try {
            await axios.post('https://sf.doaguru.com/api/categories', { name: categoryName });
    ...
    const handleAddSubCategory = async () => {
        ...
        try {
            await axios.post('https://sf.doaguru.com/api/subcategories', { name: subCategoryName, category_id: selectedCategoryId });
