                  ...
                  {paginatedData.length > 0 ? (
                    paginatedData.map((row) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-2.5">
                          <span className={`px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5 w-max border shadow-sm ${
                            row.abr_status === "approved" ? "bg-emerald-50 text-emerald-600 border-emerald-100" :
                            row.abr_status === "rejected" ? "bg-rose-50 text-rose-600 border-rose-100" :
                            "bg-amber-50 text-amber-600 border-amber-100"
                          }`}>
                            <div className={`w-1 h-1 rounded-full ${
                              row.abr_status === "approved" ? "bg-emerald-600" :
