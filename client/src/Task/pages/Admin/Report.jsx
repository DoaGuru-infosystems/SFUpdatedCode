        ...
        <div className="flex items-center gap-1">
          {pageNumbers.map(num => (
            <button
              key={num}
              onClick={() => setPage(num)}
              className={`w-7 h-7 rounded-lg font-black text-[10px] transition-all ${page === num
                  ...
                  >
                    <div className="overflow-y-auto custom-scrollbar p-2 space-y-1">
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 rounded-xl text-xs font-black transition-all ${selectedUserId === "all" ? "bg-indigo-600 text-white" : "hover:bg-slate-50 text-indigo-600 italic"
                          }`}
                      >
                        Global Analytics
                      </button>
                      ...
                      {filteredUsers.length > 0 ? (
                        filteredUsers.map(u => (
                          <button
                            ...
                            className={`w-full text-left px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${selectedUserId === u.id ? "bg-indigo-600 text-white" : "hover:bg-slate-50 text-slate-700"
                              }`}
                          >
