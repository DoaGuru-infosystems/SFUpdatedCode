...
const SalaryManagement = ({ employeeId, baseSalary }) => {
    ...
    const fetchHistory = async () => {
        try {
            const { data } = await axios.get(`https://sf.doaguru.com/api/salary/history/${employeeId}`);
            if (data.success) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editModeId) {
                const { data } = await axios.put(`https://sf.doaguru.com/api/salary/update/${editModeId}`, {
                    ...formData,
                ...
                const { data } = await axios.post('https://sf.doaguru.com/api/salary/pay', {
                    ...formData,
                    payment_duration: formattedDuration,
    ...
    const deleteRecord = async (id) => {
        ...
        try {
            await axios.delete(`https://sf.doaguru.com/api/salary/delete/${id}`);
