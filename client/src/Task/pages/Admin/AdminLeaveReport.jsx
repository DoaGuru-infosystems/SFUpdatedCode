                ...
                {isLoading ? (
                  ...
                  paginatedData.map((leave, index) => {
                    ...
                    return (
                        ...
                        <td className="px-3 py-2.5 text-center">
                            <span className={`px-2.5 py-1 rounded-full font-black text-[9px] uppercase tracking-widest border shadow-sm ${
                            leave.leave_status === "approved" ? "bg-emerald-50 text-emerald-700 border-emerald-100" :
