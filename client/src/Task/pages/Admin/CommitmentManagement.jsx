...
const CommitmentManagement = ({ employeeId, readOnly = false }) => {
    ...
    const fetchUniqueRoles = async () => {
        try {
            const { data } = await axios.get('https://sf.doaguru.com/api/commitments/roles');
    ...
    const fetchCommitments = async () => {
        try {
            const { data } = await axios.get(`https://sf.doaguru.com/api/commitments/history/${employeeId}`);
            if (data.success) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editModeId) {
                const { data } = await axios.put(`https://sf.doaguru.com/api/commitments/update/${editModeId}`, {
                ...
                const { data } = await axios.post('https://sf.doaguru.com/api/commitments/add', {
                    commitment_text: commitmentText,
                    role: role,
    ...
    const deleteRecord = async (id) => {
        ...
        try {
            await axios.delete(`https://sf.doaguru.com/api/commitments/delete/${id}`);
