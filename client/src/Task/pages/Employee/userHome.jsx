                    ...
                    <div className="md:col-span-2 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {["Complete", "In Progress", "ReEditing"].map((status) => (
                          <label key={status} className={`flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest cursor-pointer transition-all border ${
                            (formData.PostCreativeStatus === status || formData.VideoStatus === status || formData.OtherGraphicsStatus === status) 
