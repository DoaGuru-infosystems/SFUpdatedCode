                      ...
                      <td className="px-4 py-2 text-right">
                        <div className="flex justify-end gap-1.5">
                          <button
                            ...
                            className={`px-2 py-1 rounded-md font-black text-[9px] uppercase tracking-wider transition-all ${row.abr_status === "approved" ? "invisible" : "bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white"
                              }`}
