...
const { getReminders, getReminderById, getReminderStats, createReminder, updateReminder, deleteReminder, completeReminder, triggerReminder, testWhatsApp } = require('../controller/scheduler/reminderController');
const { getNotifications, getUnreadNotifications, getNotificationHistory, markAsRead, markAllAsRead } = require('../controller/scheduler/notificationController');
